 ...
 */
public final class Pose implements Serializable, Cloneable {

    protected final static String format = "X:%.0f Y:%.0f H:%.0f";
    ...
    public Pose(Pose pose) {
        _location = pose._location;
        _heading = pose._heading;
    }
    ...
    public String toString() {
        return String.format(Locale.ENGLISH, format, _location.x, _location.y, _heading);
    }
